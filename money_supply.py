...
def stats_money_supply(datestr):
    url='https://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=hgyd&rowcode=zb&colcode=sj&wds=[]&dfwds=[{"wdcode":"zb","valuecode":"A0D01"},{"wdcode":"sj","valuecode":"'+datestr+'"}]&k1='+random_timestamp()
